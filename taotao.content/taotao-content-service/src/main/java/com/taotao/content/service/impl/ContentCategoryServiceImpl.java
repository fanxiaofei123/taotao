...
public class ContentCategoryServiceImpl implements ContentCategoryService {
	...
	@Override
	public int updateContentCategoryName(Long id, String name) {
		TbContentCategory tbContentCategory = new TbContentCategory();
		tbContentCategory.setId(id);
		tbContentCategory.setName(name);
		return contentCategoryMapper.updateByPrimaryKeySelective(tbContentCategory);
	}
	...
	public int deleteContentCategory(Long id) {
		...
		if(selectByExample.size() < 2) {
			TbContentCategory tbContentCategory2 = contentCategoryMapper.selectByPrimaryKey(tbContentCategory.getParentId());
			tbContentCategory2.setIsParent(false);
			contentCategoryMapper.updateByExampleSelective(tbContentCategory2, null);
		}
//		TbContentCategoryExample example1 = new TbContentCategoryExample();
//		Criteria criteria1 = example1.createCriteria();
//		criteria1.andParentIdEqualTo(id);
//		List<TbContentCategory> selectByExample2 = contentCategoryMapper.selectByExample(example1);
